...
const POLICY = "Be concise without omitting necessary explanations, uncertainty, evidence, security or useful code comments. Lead with the result; avoid filler and repetition. Preserve the user's language and accents. Prefer the smallest correct change and targeted checks. Do not delegate trivial tasks or spawn workers without authorization. Never claim measured savings without measurements.";
